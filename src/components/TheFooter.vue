<template>
    <div class="mt-6">
        <div class="flex items-center justify-center space-x-6 my-2">
            <a class="cursor-pointer" href="https://github.com/DevHumbleChris">
            ...
            <a class="cursor-pointer" href="https://www.linkedin.com/in/christopher-odhiambo-2870331aa">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48"
                    class="w-9 h-9" fill="#000000">
                    <path fill="#0078d4"
            ...
            <a class="cursor-pointer" href="https://twitter.com/AmChrisKE?t=CuF7ruFOTdF03j7AzVpOgw&s=09">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48"
                    class="w-9 h-9" fill="#000000">
                    <linearGradient id="_osn9zIN2f6RhTsY8WhY4a_5MQ0gPAYYx7a_gr1" x1="10.341" x2="40.798" y1="8.312"
            ...
            <a class="cursor-pointer" href="https://wa.me/message/BSLLTZE6NKUIF1">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="96" height="96" viewBox="0 0 48 48"
                    class="w-10 h-10" fill="#000000">
                    <path fill="#fff"
